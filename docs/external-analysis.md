...
v0.3.0 is the latest Packagist release, so the installation command below uses `^0.3` and the v0.3 behavior documented on this page is the published behavior.
