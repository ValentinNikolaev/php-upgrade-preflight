...
1. Define and snapshot the v0.1 JSON schema before populating its remaining sections.
2. Populate root constraint changes, staged actions, test guidance, and uncertainty output.
