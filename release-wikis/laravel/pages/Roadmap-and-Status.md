...
Release-specific publication repositories are managed separately as documented in [Release Wiki Strategy](https://github.com/ValentinNikolaev/php-upgrade-preflight/wiki/Release-Wiki-Strategy).
