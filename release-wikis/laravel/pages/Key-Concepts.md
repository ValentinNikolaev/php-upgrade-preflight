...
- Run a first analysis: [[Getting Started|Getting-Started]].
...
- Build an adapter: [Writing a Framework Adapter](https://github.com/ValentinNikolaev/php-upgrade-preflight/wiki/Writing-a-Framework-Adapter).
