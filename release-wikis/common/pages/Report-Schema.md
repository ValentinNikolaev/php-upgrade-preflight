...
PHP Upgrade Preflight v0.3.x writes canonical JSON schema 0.8. The normative file is [`upgrade-report-v0.8.schema.json`](https://github.com/ValentinNikolaev/php-upgrade-preflight/blob/main/packages/core/resources/schema/upgrade-report-v0.8.schema.json), a strict JSON Schema Draft 2020-12 document.
