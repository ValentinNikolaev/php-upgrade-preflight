...
- [[CLI Reference|Home]] documents every standalone option.
- [Artisan Command](https://github.com/ValentinNikolaev/php-upgrade-preflight/wiki/Artisan-Command) covers project-hosted Laravel use.
...
- [Reading the Report](https://github.com/ValentinNikolaev/php-upgrade-preflight/wiki/Reading-the-Report) explains schema 0.8 for developers and managers.
